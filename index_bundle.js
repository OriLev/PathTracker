...
var _HashRouter2 = __webpack_require__(73);
...
var _MemoryRouter2 = __webpack_require__(75);
...
var _StaticRouter2 = __webpack_require__(89);
...
var _override = __webpack_require__(54);
...
var _suppressWarnings = __webpack_require__(56);
...
var _memoize = __webpack_require__(57);
...
var _autobind = __webpack_require__(58);
...
var _readonly = __webpack_require__(59);
...
var _enumerable = __webpack_require__(60);
...
var _nonenumerable = __webpack_require__(61);
...
var _nonconfigurable = __webpack_require__(62);
...
var _decorate = __webpack_require__(65);
...
var _extendDescriptor = __webpack_require__(68);
...
var _applyDecorators = __webpack_require__(70);
...
exports.default = InstructionsBox;
...
InstructionsBox.propTypes = {
  instructions: _propTypes2.default.array.isRequired
};
...
var _coreDecorators = __webpack_require__(29);

var _reactRouterDom = __webpack_require__(16);

var _BFS = __webpack_require__(97);
...
var _SettingsScreen = __webpack_require__(107);
...
function createBoard(lengthX, lengthY) {
  ...
  var board = [];
  for (var i = 0; i < lengthY; i += 1) {
    board[i] = [];
    for (var j = 0; j < lengthX; j += 1) {
      board[i][j] = {
...
var App = (_class = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function resetBoard() {
      var _props$dimensions = this.props.dimensions,
    ...
    key: 'setBoardColor',
    value: function setBoardColor(colorName, colorValue) {
      this.setState(_defineProperty({}, colorName, colorValue));
    }
  }, {
    key: 'setStartLocation',
    value: function setStartLocation(x, y) {
      this.setState({
    ...
    key: 'setEndLocation',
    value: function setEndLocation(x, y) {
      this.setState({
        pathEndingPoint: [x, y],
        endButtonPressed: false
      });
    ...
    value: function handleClickOnBoard(x, y) {
      var _state = this.state,
          startButtonPressed = _state.startButtonPressed,
          endButtonPressed = _state.endButtonPressed;
    ...
    key: 'toggleIsCellAllowedToBeSteppedOn',
    value: function toggleIsCellAllowedToBeSteppedOn(x, y) {
    ...
    key: 'toggleStartButtonPressed',
    value: function toggleStartButtonPressed() {
      this.setState({
    ...
    key: 'toggleEndButtonPressed',
    value: function toggleEndButtonPressed() {
      this.setState({
    ...
    key: 'findAndDrawPath',
    value: function findAndDrawPath() {
      this.setState({ goButtonPressed: true });
      var _state2 = this.state,
          pathStartingPoint = _state2.pathStartingPoint,
          pathEndingPoint = _state2.pathEndingPoint,
          board = _state2.board;
      ...
      var path = (0, _BFS2.default)(findPathParameters);
      var stepCounter = -1;
      this.drawPath(path, stepCounter);
    }
  }, {
    key: 'drawPath',
    value: function drawPath(pathRemaining, stepNumber) {
    ...
    key: 'addStepToPathOnBoard',
    value: function addStepToPathOnBoard(step, stepNum) {
      var board = this.state.board;
    ...
    value: function render() {
      var resetBoard = this.resetBoard,
          handleClickOnBoard = this.handleClickOnBoard,
          toggleStartButtonPressed = this.toggleStartButtonPressed,
          toggleEndButtonPressed = this.toggleEndButtonPressed,
          findAndDrawPath = this.findAndDrawPath,
          setBoardColor = this.setBoardColor;

      var handleClicks = {
        handleClickOnBoard: handleClickOnBoard,
        toggleStartButtonPressed: toggleStartButtonPressed,
        toggleEndButtonPressed: toggleEndButtonPressed,
        findAndDrawPath: findAndDrawPath
      };
      var _state3 = this.state,
          colorA = _state3.colorA,
          colorB = _state3.colorB,
          colorC = _state3.colorC,
          board = _state3.board,
          pathStartingPoint = _state3.pathStartingPoint,
          pathEndingPoint = _state3.pathEndingPoint,
          startButtonPressed = _state3.startButtonPressed,
          endButtonPressed = _state3.endButtonPressed,
          goButtonPressed = _state3.goButtonPressed;
      ...
      var gameState = {
        ...
        pathEndingPoint: pathEndingPoint,
        startButtonPressed: startButtonPressed,
        endButtonPressed: endButtonPressed,
  ...
  return App;
}(_react2.default.Component), (_applyDecoratedDescriptor(_class.prototype, 'resetBoard', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, 'resetBoard'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'setBoardColor', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, 'setBoardColor'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'handleClickOnBoard', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, 'handleClickOnBoard'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'toggleStartButtonPressed', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, 'toggleStartButtonPressed'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'toggleEndButtonPressed', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, 'toggleEndButtonPressed'), _class.prototype), _applyDecoratedDescriptor(_class.prototype, 'findAndDrawPath', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, 'findAndDrawPath'), _class.prototype)), _class);
exports.default = App;
...
var _MemoryRouter = __webpack_require__(76);
...
var _Prompt = __webpack_require__(82);
...
var _createBrowserHistory2 = __webpack_require__(86);
...
var _StaticRouter = __webpack_require__(90);
...
var _withRouter = __webpack_require__(95);
...
function findPath(_ref) {
  ...
  var inField = function inField(point) {
  ...
  var visited = function visited(point) {
  ...
  var allowedStep = function allowedStep(point) {
  ...
  var isEndPoint = function isEndPoint(point) {
    if (point === endPoint) {
      return true;
    }
    return false;
  ...
  var getNeighbours = function getNeighbours(point) {
    var neighbours = [];
  ...
  var legalPoint = function legalPoint(point) {
    if (inField(point)) {
  ...
  var legalNeighbours = function legalNeighbours(neighbours) {
    var legal = [];
  ...
  var pathExists = function pathExists() {
    if (legalPoint(startPoint) && legalPoint(endPoint)) {
      var _ret = function () {
        var testingQue = [startPoint];
        field[testingQue[0][0]][testingQue[0][1]].numberOfStepInPath = 0;

        var _loop = function _loop() {
          var currStep = testingQue[0];
          if (currStep[0] === endPoint[0] && currStep[1] === endPoint[1]) return {
              v: {
                v: true
              }
            };

          var currStepNum = field[currStep[0]][currStep[1]].numberOfStepInPath;
          var allowedSteps = legalNeighbours(getNeighbours(currStep));
  ...
  var buildPath = function buildPath() {
    var stepNum = field[endPoint[0]][endPoint[1]].numberOfStepInPath;
    var currStep = endPoint;
    path[0] = startPoint;
    while (stepNum > 0) {
...
var _GameHeader = __webpack_require__(99);

var _GameHeader2 = _interopRequireDefault(_GameHeader);

var _GameScreen = __webpack_require__(101);
...
function Game(_ref) {
  var resetBoard = _ref.resetBoard,
      _ref$gameState = _ref.gameState,
      colorA = _ref$gameState.colorA,
      colorB = _ref$gameState.colorB,
      colorC = _ref$gameState.colorC,
      board = _ref$gameState.board,
      pathStartingPoint = _ref$gameState.pathStartingPoint,
      pathEndingPoint = _ref$gameState.pathEndingPoint,
      startButtonPressed = _ref$gameState.startButtonPressed,
      endButtonPressed = _ref$gameState.endButtonPressed,
      goButtonPressed = _ref$gameState.goButtonPressed,
      handleClicks = _ref.handleClicks;
  ...
  var gameHeaderProps = { resetBoard: resetBoard, gameHeaderState: gameHeaderState };
  return _react2.default.createElement(
    'div',
    { className: 'gameContainer' },
    _react2.default.createElement(_GameHeader2.default, gameHeaderProps),
    _react2.default.createElement(_GameScreen2.default, gameScreenProps)
  );
}

Game.propTypes = {
  gameState: _propTypes2.default.object.isRequired,
  handleClicks: _propTypes2.default.object.isRequired
};
...
var _GameInstructions = __webpack_require__(100);

var _GameInstructions2 = _interopRequireDefault(_GameInstructions);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function GameHeader(_ref) {
  var resetBoard = _ref.resetBoard,
      _ref$gameHeaderState = _ref.gameHeaderState,
      pathStartingPoint = _ref$gameHeaderState.pathStartingPoint,
      pathEndingPoint = _ref$gameHeaderState.pathEndingPoint,
      startButtonPressed = _ref$gameHeaderState.startButtonPressed,
      endButtonPressed = _ref$gameHeaderState.endButtonPressed;
  ...
  var instructionsProps = { instructionsState: instructionsState };
  var linkProps = {
    // href: '/settings',
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_GameInstructions2.default, instructionsProps)
    )
  );
}

GameHeader.propTypes = {
  gameHeaderState: _propTypes2.default.object.isRequired
};
...
exports.default = GameInstructions;
...
var _InstructionsBox = __webpack_require__(38);

var _InstructionsBox2 = _interopRequireDefault(_InstructionsBox);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function GameInstructions(_ref) {
  var instructionsState = _ref.instructionsState;

  function createInstructions(appState) {
    var instructionsList = [];
    var pathStartingPoint = appState.pathStartingPoint,
        pathEndingPoint = appState.pathEndingPoint,
        startButtonPressed = appState.startButtonPressed,
        endButtonPressed = appState.endButtonPressed;

    var getGoBackText = function getGoBackText(buttonText) {
      return 'Press on the "' + buttonText + '" button in order to go back to toggle mode';
    };
    var getSetReferencePointText = function getSetReferencePointText(buttonText) {
      return 'Press on a tile to set it as the "' + buttonText + '" of the path';
    };
    var addInstruction = instructionsList.push.bind(instructionsList);
    var toggleTile = 'Press on tiles to toggle tile availability';
    var goToChooseStartMode = 'Press the "START" button to set the starting point';
    var goToChooseEndMode = 'Press the "END" button to set the ending point';
    var setReferencePoint = getSetReferencePointText(startButtonPressed ? 'Start' : 'End');
    var goBackToToggleTileMode = getGoBackText(startButtonPressed ? 'START' : 'END');
    var findAndDrawPath = 'Press the "GO!" button to draw path';
    var pathStartingPointSet = !(pathStartingPoint.length === 0);
    var pathEndingPointSet = !(pathEndingPoint.length === 0);
  ...
  var currentInstructions = createInstructions(instructionsState);
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(_InstructionsBox2.default, { instructions: currentInstructions })
  );
}

GameInstructions.propTypes = {
  instructionsState: _propTypes2.default.object.isRequired
};
...
var _GameButtonsPanel = __webpack_require__(105);

var _GameButtonsPanel2 = _interopRequireDefault(_GameButtonsPanel);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function GameScreen(_ref) {
  var _ref$gameScreenState = _ref.gameScreenState,
      colorA = _ref$gameScreenState.colorA,
      colorB = _ref$gameScreenState.colorB,
      colorC = _ref$gameScreenState.colorC,
      board = _ref$gameScreenState.board,
      pathStartingPoint = _ref$gameScreenState.pathStartingPoint,
      pathEndingPoint = _ref$gameScreenState.pathEndingPoint,
      startButtonPressed = _ref$gameScreenState.startButtonPressed,
      endButtonPressed = _ref$gameScreenState.endButtonPressed,
      goButtonPressed = _ref$gameScreenState.goButtonPressed,
      _ref$handleClicks = _ref.handleClicks,
      toggleStartButtonPressed = _ref$handleClicks.toggleStartButtonPressed,
      toggleEndButtonPressed = _ref$handleClicks.toggleEndButtonPressed,
      findAndDrawPath = _ref$handleClicks.findAndDrawPath,
      handleClickOnBoard = _ref$handleClicks.handleClickOnBoard;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_Board2.default, boardProps)
    ),
    _react2.default.createElement(_GameButtonsPanel2.default, buttonPanelProps)
  );
}

GameScreen.propTypes = {
  gameScreenState: _propTypes2.default.object.isRequired,
  handleClicks: _propTypes2.default.object.isRequired
};
...
function Board(_ref) {
  var _ref$boardState = _ref.boardState,
      colorA = _ref$boardState.colorA,
      colorB = _ref$boardState.colorB,
      colorC = _ref$boardState.colorC,
      board = _ref$boardState.board,
      pathStartingPoint = _ref$boardState.pathStartingPoint,
      pathEndingPoint = _ref$boardState.pathEndingPoint,
      handleClickOnBoard = _ref.handleClickOnBoard;

  return _react2.default.createElement(
    'div',
    { className: 'board' },
    board.map(function (row, indexY) {
      var rowState = {
        colorA: colorA,
        colorB: colorB,
        colorC: colorC,
...
Board.propTypes = {
  boardState: _propTypes2.default.object.isRequired,
  handleClickOnBoard: _propTypes2.default.func.isRequired
};
...
function Row(_ref) {
  var _ref$rowState = _ref.rowState,
      colorA = _ref$rowState.colorA,
      colorB = _ref$rowState.colorB,
      colorC = _ref$rowState.colorC,
      rowHeight = _ref$rowState.rowHeight,
      row = _ref$rowState.row,
      pathStartingPoint = _ref$rowState.pathStartingPoint,
      pathEndingPoint = _ref$rowState.pathEndingPoint,
      indexY = _ref.indexY,
      handleClickOnBoard = _ref.handleClickOnBoard;
...
Row.propTypes = {
  rowState: _propTypes2.default.object.isRequired,
  indexY: _propTypes2.default.number.isRequired,
  handleClickOnBoard: _propTypes2.default.func.isRequired
};
...
function Cell(_ref) {
  var _ref$cellState = _ref.cellState,
      colorA = _ref$cellState.colorA,
      colorB = _ref$cellState.colorB,
      colorC = _ref$cellState.colorC,
      cellSideLength = _ref$cellState.cellSideLength,
      cell = _ref$cellState.cell,
      pathStartingPoint = _ref$cellState.pathStartingPoint,
      pathEndingPoint = _ref$cellState.pathEndingPoint,
      _ref$cellCoordinates = _ref.cellCoordinates,
      x = _ref$cellCoordinates.x,
      y = _ref$cellCoordinates.y,
      handleClickOnBoard = _ref.handleClickOnBoard;

  function getCellColor(currentCell) {
    var numberOfStepInPath = currentCell.numberOfStepInPath,
        isAllowedToBeSteppedOn = currentCell.isAllowedToBeSteppedOn;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      cellProps,
      pathStartingPoint[0] === x && pathStartingPoint[1] === y && _react2.default.createElement(
        'div',
        null,
        'start'
      ),
      pathEndingPoint[0] === x && pathEndingPoint[1] === y && _react2.default.createElement(
        'div',
        null,
        'end'
      )
...
Cell.propTypes = {
  cellState: _propTypes2.default.object.isRequired,
  cellCoordinates: _propTypes2.default.object.isRequired,
  handleClickOnBoard: _propTypes2.default.func.isRequired
};
...
exports.default = GameButtonsPanel;
...
var _ButtonsGroup = __webpack_require__(106);

var _ButtonsGroup2 = _interopRequireDefault(_ButtonsGroup);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function GameButtonsPanel(_ref) {
  var _ref$buttonsState = _ref.buttonsState,
      pathStartingPoint = _ref$buttonsState.pathStartingPoint,
      pathEndingPoint = _ref$buttonsState.pathEndingPoint,
      startButtonPressed = _ref$buttonsState.startButtonPressed,
      endButtonPressed = _ref$buttonsState.endButtonPressed,
      goButtonPressed = _ref$buttonsState.goButtonPressed,
      toggleStartButtonPressed = _ref.toggleStartButtonPressed,
      toggleEndButtonPressed = _ref.toggleEndButtonPressed,
      findAndDrawPath = _ref.findAndDrawPath;

  var isStartOrEndButtonDisabled = function isStartOrEndButtonDisabled(location) {
    return location.length > 0;
  };
  var isGoButtonDisabled = function isGoButtonDisabled(locationOfStart, locationOfEnd) {
    return !isStartOrEndButtonDisabled(locationOfStart) || !isStartOrEndButtonDisabled(locationOfEnd) || goButtonPressed;
  };
  var getButtonClasses = function getButtonClasses(isButtonPressed) {
    return 'btn' + (isButtonPressed ? ' pressed' : '');
  };
  var buttons = [{
    text: 'START',
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_ButtonsGroup2.default, { buttons: buttons })
  );
}

GameButtonsPanel.propTypes = {
  buttonsState: _propTypes2.default.object.isRequired,
  toggleStartButtonPressed: _propTypes2.default.func.isRequired,
  toggleEndButtonPressed: _propTypes2.default.func.isRequired,
  findAndDrawPath: _propTypes2.default.func.isRequired
};
...
var _PageMain = __webpack_require__(109);
...
function SettingsScreen(_ref) {
  var colorA = _ref.colorA,
      colorB = _ref.colorB,
      colorC = _ref.colorC,
      setBoardColor = _ref.setBoardColor;

  var headerProps = { instructions: ['Press on the color squares to choose new colors'] };
  var mainProps = {
    colorA: colorA,
    colorB: colorB,
    colorC: colorC,
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_PageHeader2.default, headerProps),
    _react2.default.createElement(_PageMain2.default, mainProps)
  );
}

SettingsScreen.propTypes = {
  colorA: _propTypes2.default.string.isRequired,
  colorB: _propTypes2.default.string.isRequired,
  colorC: _propTypes2.default.string.isRequired,
  setBoardColor: _propTypes2.default.func.isRequired
};
...
function PageHeader(_ref) {
  ...
  var instructionsProps = { instructions: instructions };
  return _react2.default.createElement(
    'div',
    { className: 'pageHeader' },
    _react2.default.createElement(
      'div',
      { className: 'instructionsWrapper' },
      _react2.default.createElement(_InstructionsBox2.default, instructionsProps)
    )
  );
}
...
var _SettingsPanel = __webpack_require__(110);
...
function PageMain(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    { className: 'pageMain' },
    _react2.default.createElement(_SettingsPanel2.default, panelProps)
  );
}
...
var _NewColorsInput = __webpack_require__(111);

var _NewColorsInput2 = _interopRequireDefault(_NewColorsInput);

var _SubmitColorsButton = __webpack_require__(113);

var _SubmitColorsButton2 = _interopRequireDefault(_SubmitColorsButton);
...
var SettingsPanel = (_class = function (_React$Component) {
  ...
  function SettingsPanel(props) {
    ...
    var _this$props = _this.props,
        colorA = _this$props.colorA,
        colorB = _this$props.colorB,
        colorC = _this$props.colorC;
    ...
    _this.newColorNames = Object.keys(_this.state);
    return _this;
  }
  ...
  _createClass(SettingsPanel, [{
    ...
    value: function componentWillUpdate(nextProps, nextState) {
      var stateValidation = this.stateValidation,
          newColorNames = this.newColorNames;

      var isHexColor = function isHexColor(colorKey) {
    ...
    value: function componentWillUnmount() {
      var setBoardColor = this.props.setBoardColor;
      ...
      function updateBoardColor(color) {
        var colorLetter = color.slice(-1);
        var newColorValue = getColor(color);
    ...
    key: 'updateNewColor',
    value: function updateNewColor(e, colorLetter) {
      this.setState(_defineProperty({}, 'newColor' + colorLetter, e.target.value));
    }
  }, {
    key: 'render',
    value: function render() {
      var newColors = this.state,
          updateNewColor = this.updateNewColor,
          stateValidation = this.stateValidation,
          newColorNames = this.newColorNames;
      ...
      var inputProps = {
        ...
        newColorNames: newColorNames
      };
      return _react2.default.createElement(
        'div',
        { className: 'settingsPanel' },
        _react2.default.createElement(_NewColorsInput2.default, inputProps),
        _react2.default.createElement(_SubmitColorsButton2.default, null)
      );
    }
  }]);

  return SettingsPanel;
}(_react2.default.Component), (_applyDecoratedDescriptor(_class.prototype, 'updateNewColor', [_coreDecorators.autobind], Object.getOwnPropertyDescriptor(_class.prototype, 'updateNewColor'), _class.prototype)), _class);
...
exports.default = NewColorsInput;
...
var _ColorInput = __webpack_require__(112);
...
function NewColorsInput(_ref) {
  var newColors = _ref.newColors,
      updateNewColor = _ref.updateNewColor,
      stateValidation = _ref.stateValidation,
      newColorNames = _ref.newColorNames;
  ...
  var colors = newColorNames.map(createColors);
  ...
  function createNewColorInputContainer(color) {
    ...
    var colorLetter = colorName.slice(-1);
    var colorInputProps = {
    ...
    return _react2.default.createElement(
      'div',
      { className: 'inputContainer', key: colorLetter },
      _react2.default.createElement(_ColorInput2.default, colorInputProps)
    );
  }
  return _react2.default.createElement(
    'div',
    { className: 'colorInputsWrapper' },
    colors.map(createNewColorInputContainer)
  );
}

NewColorsInput.propTypes = {
  newColors: _propTypes2.default.object.isRequired,
  updateNewColor: _propTypes2.default.func.isRequired,
  stateValidation: _propTypes2.default.object.isRequired,
  newColorNames: _propTypes2.default.array.isRequired
};
...
function ColorInput(_ref) {
  var colorLetter = _ref.colorLetter,
...
ColorInput.propTypes = {
  colorLetter: _propTypes2.default.string.isRequired,
  colorValue: _propTypes2.default.string.isRequired,
...
exports.default = SubmitColorsButton;
